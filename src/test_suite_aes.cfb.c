...
void test_suite_aes_encrypt_xts( char *hex_key_string, char *hex_data_unit_string,
                      char *hex_src_string, char *hex_dst_string )
{
...
#ifdef MBEDTLS_CIPHER_MODE_XTS
#line 198 "suites/test_suite_aes.function"
void test_suite_aes_decrypt_xts( char *hex_key_string, char *hex_data_unit_string,
...
#ifdef MBEDTLS_CIPHER_MODE_XTS
#line 241 "suites/test_suite_aes.function"
void test_suite_aes_crypt_xts_size( int size, int retval )
{
    mbedtls_aes_xts_context ctx;
...
#ifdef MBEDTLS_CIPHER_MODE_XTS
#line 262 "suites/test_suite_aes.function"
void test_suite_aes_crypt_xts_keysize( int size, int retval )
{
    mbedtls_aes_xts_context ctx;
...
#line 279 "suites/test_suite_aes.function"
...
#ifdef MBEDTLS_CIPHER_MODE_CFB
#line 314 "suites/test_suite_aes.function"
...
#ifdef MBEDTLS_CIPHER_MODE_CFB
#line 349 "suites/test_suite_aes.function"
...
#ifdef MBEDTLS_CIPHER_MODE_CFB
#line 383 "suites/test_suite_aes.function"
...
#line 417 "suites/test_suite_aes.function"
void test_suite_aes_encrypt_ofb( int fragment_size, char *hex_key_string,
...
#line 474 "suites/test_suite_aes.function"
...
int dispatch_test(int cnt, char *params[50])
{
    ...
    if( strcmp( params[0], "aes_encrypt_xts" ) == 0 )
    {
    #ifdef MBEDTLS_CIPHER_MODE_XTS
        ...
        test_suite_aes_encrypt_xts( param1, param2, param3, param4 );
        return ( DISPATCH_TEST_SUCCESS );
    #endif /* MBEDTLS_CIPHER_MODE_XTS */
    ...
    if( strcmp( params[0], "aes_decrypt_xts" ) == 0 )
    {
    #ifdef MBEDTLS_CIPHER_MODE_XTS
        ...
        test_suite_aes_decrypt_xts( param1, param2, param3, param4 );
        return ( DISPATCH_TEST_SUCCESS );
    #endif /* MBEDTLS_CIPHER_MODE_XTS */
    ...
    if( strcmp( params[0], "aes_crypt_xts_size" ) == 0 )
    {
    #ifdef MBEDTLS_CIPHER_MODE_XTS
        ...
        test_suite_aes_crypt_xts_size( param1, param2 );
        return ( DISPATCH_TEST_SUCCESS );
    #endif /* MBEDTLS_CIPHER_MODE_XTS */
    ...
    if( strcmp( params[0], "aes_crypt_xts_keysize" ) == 0 )
    {
    #ifdef MBEDTLS_CIPHER_MODE_XTS
        ...
        test_suite_aes_crypt_xts_keysize( param1, param2 );
        return ( DISPATCH_TEST_SUCCESS );
    #endif /* MBEDTLS_CIPHER_MODE_XTS */
    ...
    if( strcmp( params[0], "aes_encrypt_ofb" ) == 0 )
    {
    #ifdef MBEDTLS_CIPHER_MODE_OFB
        ...
        test_suite_aes_encrypt_ofb( param1, param2, param3, param4, param5 );
        return ( DISPATCH_TEST_SUCCESS );
    #endif /* MBEDTLS_CIPHER_MODE_OFB */
